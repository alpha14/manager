 ...
 * upgrades.
 * All carts must be assigned before to be used.
 */
export default class OrderCartService {
   ...
   * cart, with identification informations to add configuration if needed
   */
  ...
  /**
   * Add an option for a new product tp order
   *
   * @param  {string} cartId      Identification number of the cart
   * @param  {string} productName Name of the product
  ...
  /**
   * Delete a configuration item of the product
   *
   * @param  {string} cartId          Identification number of the cart
  ...
  /**
   * Get the informations for checkout a order
   *
   * @param  {string} cartId    Identification number of the cart
   * @return {Promise<Object>}  Promise of the checkout informations
   */
  ...
  /**
   * Get the details of product, in the public catalog, for a given subsidiary
   *
